...
#' Would they take over the entire ocean? After 256 days in the example
#' above, there would be a total of 26984457539 lanternfish!

#' How many lanternfish would there be after 256 days?
#'
#' @param init list of initial fish counter
#' @param days number of days after initial day
